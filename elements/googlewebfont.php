...
class JFormFieldGooglewebfont extends JFormFieldList
{
    ...
    protected function getOptions()
    {
        ...
        $options[] = JHtml::_('select.option', 'Acme', 'Acme');
        $options[] = JHtml::_('select.option', 'Actor', 'Actor');
        $options[] = JHtml::_('select.option', 'Adamina', 'Adamina');
        $options[] = JHtml::_('select.option', 'Advent+Pro', 'Advent Pro');
        ...
        $options[] = JHtml::_('select.option', 'Alegreya', 'Alegreya');
        $options[] = JHtml::_('select.option', 'Alegreya+SC', 'Alegreya SC');
        $options[] = JHtml::_('select.option', 'Alex+Brush', 'Alex Brush');
        $options[] = JHtml::_('select.option', 'Alfa+Slab+One', 'Alfa Slab One');
        ...
        $options[] = JHtml::_('select.option', 'Allura', 'Allura');
        $options[] = JHtml::_('select.option', 'Almendra', 'Almendra');
        $options[] = JHtml::_('select.option', 'Almendra+SC', 'Almendra SC');
        $options[] = JHtml::_('select.option', 'Amaranth', 'Amaranth');
        $options[] = JHtml::_('select.option', 'Amatic+SC', 'Amatic SC');
        $options[] = JHtml::_('select.option', 'Amethysta', 'Amethysta');
        ...
        $options[] = JHtml::_('select.option', 'Arizonia', 'Arizonia');
        $options[] = JHtml::_('select.option', 'Armata', 'Armata');
        $options[] = JHtml::_('select.option', 'Artifika', 'Artifika');
        $options[] = JHtml::_('select.option', 'Arvo', 'Arvo');
        $options[] = JHtml::_('select.option', 'Asap', 'Asap');
        $options[] = JHtml::_('select.option', 'Asset', 'Asset');
        $options[] = JHtml::_('select.option', 'Astloch', 'Astloch');
        $options[] = JHtml::_('select.option', 'Asul', 'Asul');
        $options[] = JHtml::_('select.option', 'Atomic+Age', 'Atomic Age');
        $options[] = JHtml::_('select.option', 'Aubrey', 'Aubrey');
        $options[] = JHtml::_('select.option', 'Bad+Script', 'Bad Script');
        $options[] = JHtml::_('select.option', 'Balthazar', 'Balthazar');
        $options[] = JHtml::_('select.option', 'Bangers', 'Bangers');
        $options[] = JHtml::_('select.option', 'Basic', 'Basic');
        $options[] = JHtml::_('select.option', 'Baumans', 'Baumans');
        $options[] = JHtml::_('select.option', 'Belgrano', 'Belgrano');
        ...
        $options[] = JHtml::_('select.option', 'Bilbo+Swash+Caps', 'Bilbo Swash Caps');
        ...
        $options[] = JHtml::_('select.option', 'Boogaloo', 'Boogaloo');
        ...
        $options[] = JHtml::_('select.option', 'Bree+Serif', 'Bree Serif');
        $options[] = JHtml::_('select.option', 'Bubblegum+Sans', 'Bubblegum Sans');
        $options[] = JHtml::_('select.option', 'Buda', 'Buda');
        $options[] = JHtml::_('select.option', 'Buenard', 'Buenard');
        $options[] = JHtml::_('select.option', 'Butcherman', 'Butcherman');
        $options[] = JHtml::_('select.option', 'Butterfly+Kids', 'Butterfly Kids');
        ...
        $options[] = JHtml::_('select.option', 'Chango', 'Chango');
        $options[] = JHtml::_('select.option', 'Chelsea+Market', 'Chelsea Market');
        ...
        $options[] = JHtml::_('select.option', 'Concert+One', 'Concert One');
        $options[] = JHtml::_('select.option', 'Condiment', 'Condiment');
        ...
        $options[] = JHtml::_('select.option', 'Creepster', 'Creepster');
        $options[] = JHtml::_('select.option', 'Crete+Round', 'Crete Round');
        ...
        $options[] = JHtml::_('select.option', 'Cutive', 'Cutive');
        ...
        $options[] = JHtml::_('select.option', 'Diplomata', 'Diplomata');
        $options[] = JHtml::_('select.option', 'Diplomata+SC', 'Diplomata SC');
        $options[] = JHtml::_('select.option', 'Doppio+One', 'Doppio One');
        ...
        $options[] = JHtml::_('select.option', 'Duru+Sans', 'Duru Sans');
        $options[] = JHtml::_('select.option', 'Dynalight', 'Dynalight');
        $options[] = JHtml::_('select.option', 'EB+Garamond', 'EB Garamond');
        $options[] = JHtml::_('select.option', 'Eater', 'Eater');
        $options[] = JHtml::_('select.option', 'Economica', 'Economica');
        $options[] = JHtml::_('select.option', 'Electrolize', 'Electrolize');
        $options[] = JHtml::_('select.option', 'Emblema+One', 'Emblema One');
        $options[] = JHtml::_('select.option', 'Emilys+Candy', 'Emilys Candy');
        $options[] = JHtml::_('select.option', 'Engagement', 'Engagement');
        $options[] = JHtml::_('select.option', 'Enriqueta', 'Enriqueta');
        $options[] = JHtml::_('select.option', 'Erica+One', 'Erica One');
        $options[] = JHtml::_('select.option', 'Esteban', 'Esteban');
        $options[] = JHtml::_('select.option', 'Euphoria+Script', 'Euphoria Script');
        $options[] = JHtml::_('select.option', 'Ewert', 'Ewert');
        $options[] = JHtml::_('select.option', 'Exo', 'Exo');
        ...
        $options[] = JHtml::_('select.option', 'Felipa', 'Felipa');
        $options[] = JHtml::_('select.option', 'Fjord+One', 'Fjord One');
        $options[] = JHtml::_('select.option', 'Flamenco', 'Flamenco');
        $options[] = JHtml::_('select.option', 'Flavors', 'Flavors');
        ...
        $options[] = JHtml::_('select.option', 'Fredericka+the+Great', 'Fredericka the Great');
        $options[] = JHtml::_('select.option', 'Fresca', 'Fresca');
        $options[] = JHtml::_('select.option', 'Frijole', 'Frijole');
        $options[] = JHtml::_('select.option', 'Fugaz+One', 'Fugaz One');
        ...
        $options[] = JHtml::_('select.option', 'Germania+One', 'Germania One');
        $options[] = JHtml::_('select.option', 'Give+You+Glory', 'Give You Glory');
        $options[] = JHtml::_('select.option', 'Glass+Antiqua', 'Glass Antiqua');
        $options[] = JHtml::_('select.option', 'Glegoo', 'Glegoo');
        ...
        $options[] = JHtml::_('select.option', 'Gudea', 'Gudea');
        $options[] = JHtml::_('select.option', 'Habibi', 'Habibi');
        $options[] = JHtml::_('select.option', 'Hammersmith+One', 'Hammersmith One');
        $options[] = JHtml::_('select.option', 'Handlee', 'Handlee');
        $options[] = JHtml::_('select.option', 'Henny+Penny', 'Henny Penny');
        ...
        $options[] = JHtml::_('select.option', 'Homenaje', 'Homenaje');
        ...
        $options[] = JHtml::_('select.option', 'Junge', 'Junge');
        ...
        $options[] = JHtml::_('select.option', 'Kaushan+Script', 'Kaushan Script');
        ...
        $options[] = JHtml::_('select.option', 'Kotta+One', 'Kotta One');
        ...
        $options[] = JHtml::_('select.option', 'Krona+One', 'Krona One');
        ...
        $options[] = JHtml::_('select.option', 'Ledger', 'Ledger');
        $options[] = JHtml::_('select.option', 'Lekton', 'Lekton');
        $options[] = JHtml::_('select.option', 'Lemon', 'Lemon');
        $options[] = JHtml::_('select.option', 'Lilita+One', 'Lilita One');
        ...
        $options[] = JHtml::_('select.option', 'Lusitana', 'Lusitana');
        $options[] = JHtml::_('select.option', 'Lustria', 'Lustria');
        $options[] = JHtml::_('select.option', 'Macondo', 'Macondo');
        $options[] = JHtml::_('select.option', 'Macondo+Swash+Caps', 'Macondo Swash Caps');
        $options[] = JHtml::_('select.option', 'Magra', 'Magra');
        ...
        $options[] = JHtml::_('select.option', 'Marko+One', 'Marko One');
        ...
        $options[] = JHtml::_('select.option', 'Medula+One', 'Medula One');
        ...
        $options[] = JHtml::_('select.option', 'Metamorphous', 'Metamorphous');
        ...
        $options[] = JHtml::_('select.option', 'Miniver', 'Miniver');
        ...
        $options[] = JHtml::_('select.option', 'Norican', 'Norican');
        $options[] = JHtml::_('select.option', 'Nosifer', 'Nosifer');
        $options[] = JHtml::_('select.option', 'Nothing+You+Could+Do', 'Nothing You Could Do');
        $options[] = JHtml::_('select.option', 'Noticia+Text', 'Noticia Text');
        ...
        $options[] = JHtml::_('select.option', 'Oldenburg', 'Oldenburg');
        ...
        $options[] = JHtml::_('select.option', 'Overlock', 'Overlock');
        $options[] = JHtml::_('select.option', 'Overlock+SC', 'Overlock SC');
        $options[] = JHtml::_('select.option', 'Ovo', 'Ovo');
        $options[] = JHtml::_('select.option', 'PT+Mono', 'PT Mono');
        ...
        $options[] = JHtml::_('select.option', 'Parisienne', 'Parisienne');
        $options[] = JHtml::_('select.option', 'Passero+One', 'Passero One');
        $options[] = JHtml::_('select.option', 'Passion+One', 'Passion One');
        $options[] = JHtml::_('select.option', 'Patrick+Hand', 'Patrick Hand');
        $options[] = JHtml::_('select.option', 'Patua+One', 'Patua One');
        ...
        $options[] = JHtml::_('select.option', 'Port+Lligat+Sans', 'Port Lligat Sans');
        $options[] = JHtml::_('select.option', 'Port+Lligat+Slab', 'Port Lligat Slab');
        $options[] = JHtml::_('select.option', 'Prata', 'Prata');
        $options[] = JHtml::_('select.option', 'Princess+Sofia', 'Princess Sofia');
        $options[] = JHtml::_('select.option', 'Prociono', 'Prociono');
        $options[] = JHtml::_('select.option', 'Prosto+One', 'Prosto One');
        $options[] = JHtml::_('select.option', 'Puritan', 'Puritan');
        $options[] = JHtml::_('select.option', 'Quantico', 'Quantico');
        ...
        $options[] = JHtml::_('select.option', 'Qwigley', 'Qwigley');
        ...
        $options[] = JHtml::_('select.option', 'Ropa+Sans', 'Ropa Sans');
        $options[] = JHtml::_('select.option', 'Rosario', 'Rosario');
        $options[] = JHtml::_('select.option', 'Rouge+Script', 'Rouge Script');
        $options[] = JHtml::_('select.option', 'Ruda', 'Ruda');
        $options[] = JHtml::_('select.option', 'Ruge+Boogie', 'Ruge Boogie');
        $options[] = JHtml::_('select.option', 'Ruluko', 'Ruluko');
        $options[] = JHtml::_('select.option', 'Ruslan+Display', 'Ruslan Display');
        $options[] = JHtml::_('select.option', 'Ruthie', 'Ruthie');
        $options[] = JHtml::_('select.option', 'Sail', 'Sail');
        ...
        $options[] = JHtml::_('select.option', 'Sarina', 'Sarina');
        $options[] = JHtml::_('select.option', 'Satisfy', 'Satisfy');
        $options[] = JHtml::_('select.option', 'Schoolbell', 'Schoolbell');
        $options[] = JHtml::_('select.option', 'Seaweed+Script', 'Seaweed Script');
        $options[] = JHtml::_('select.option', 'Sevillana', 'Sevillana');
        $options[] = JHtml::_('select.option', 'Shadows+Into+Light', 'Shadows Into Light');
        $options[] = JHtml::_('select.option', 'Shadows+Into+Light+Two', 'Shadows Into Light Two');
        $options[] = JHtml::_('select.option', 'Shanti', 'Shanti');
        $options[] = JHtml::_('select.option', 'Share', 'Share');
        $options[] = JHtml::_('select.option', 'Shojumaru', 'Shojumaru');
        ...
        $options[] = JHtml::_('select.option', 'Simonetta', 'Simonetta');
        $options[] = JHtml::_('select.option', 'Sirin+Stencil', 'Sirin Stencil');
        ...
        $options[] = JHtml::_('select.option', 'Stint+Ultra+Expanded', 'Stint Ultra Expanded');
        $options[] = JHtml::_('select.option', 'Stoke', 'Stoke');
        ...
        $options[] = JHtml::_('select.option', 'Telex', 'Telex');
        ...
        $options[] = JHtml::_('select.option', 'Titan+One', 'Titan One');
        $options[] = JHtml::_('select.option', 'Trade+Winds', 'Trade Winds');
        $options[] = JHtml::_('select.option', 'Trochut', 'Trochut');
        $options[] = JHtml::_('select.option', 'Trykker', 'Trykker');
        ...
        $options[] = JHtml::_('select.option', 'Uncial+Antiqua', 'Uncial Antiqua');
        ...
        $options[] = JHtml::_('select.option', 'Voces', 'Voces');
        ...
        $options[] = JHtml::_('select.option', 'Wellfleet', 'Wellfleet');
        ...
        $options[] = JHtml::_('select.option', 'Yesteryear', 'Yesteryear');
