        ...
        <?php if ($this->params->get('show_base_description')) : ?>
            ...
            if($this->params->get('categories_description')) : ?>
                <p class="category-desc base-desc">
                    <?php echo  JHtml::_('content.prepare',$this->params->get('categories_description'), '', 'com_newfeeds.categories'); ?>
                </p>
		    <?php  else:
		    //Otherwise get one from the database if it exists. ?>
                <?php if ($this->parent->description) : ?>
                    <section class="category-desc  base-desc">
                        <?php  echo JHtml::_('content.prepare', $this->parent->description, '', 'com_newfeeds.categories'); ?>
                    </section>
                <?php  endif; ?>
            <?php  endif; ?>
        <?php  endif; ?>
